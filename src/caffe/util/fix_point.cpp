...
void caffe_cpu_fix(const int n, Dtype*x, Dtype* y, const int bit_level, const int scale) {
...
template void caffe_cpu_fix<float>(const int n, float* x, float* y, const int bit_level, const int scale);
template void caffe_cpu_fix<double>(const int n, double* x, double* y, const int bit_level, const int scale);
